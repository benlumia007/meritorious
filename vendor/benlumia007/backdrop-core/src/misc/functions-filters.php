...
function load_archive_title() {
	if ( is_category() ) {
		$title = esc_html__( 'Category', 'backdrop' ) . '<span class="archive-description">' . single_cat_title( '', false ) . '</span>';
	} elseif ( is_tag() ) {
		$title = esc_html__( 'Tag', 'backdrop' ) . '<span class="archive-description">' . single_tag_title( '', false ) . '</span>';
	} elseif ( is_author() ) {
		$title = esc_html__( 'Author', 'backdrop' ) . '<span class="archive-description">' . get_the_author() . '</span>';
	} elseif ( is_year() ) {
		$title = esc_html__( 'Year', 'backdrop' ) . '<span class="archive-description">' . get_the_date( _x( 'Y', 'yearly archives date format', 'backdrop' ) ) . '</span>';
	} elseif ( is_month() ) {
		$title = esc_html__( 'Month', 'backdrop' ) . '<span class="archive-description">' . get_the_date( _x( 'F', 'monthly archives date format', 'backdrop' ) ) . '</span>';
	} elseif ( is_day() ) {
		$title = esc_html__( 'Day', 'backdrop' ) . '<span class="archive-description">' . get_the_date( _x( 'F j Y', 'daily archives date format', 'backdrop' ) ) . '</span>';
		...
		$title = esc_html__( 'Archives', 'backdrop' ) . '<span class="archive-description">' . post_type_archive_title( '', false ) . '</span>';
	} elseif ( is_tax() ) {
